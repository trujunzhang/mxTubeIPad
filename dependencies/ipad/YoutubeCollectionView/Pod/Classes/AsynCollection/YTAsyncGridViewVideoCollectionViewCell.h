...
- (void)bind:(YTYouTubeVideoCache *)cache placeholderImage:(UIImage *)placeholder cellSize:(CGSize)cellSize delegate:(id<IpadGridViewCellDelegate>)delegate nodeConstructionQueue:(NSOperationQueue *)nodeConstructionQueue;
@end
