...
// urlString = [NSString stringWithFormat:@"http://placekitten.com/%zd/%zd",
//                                                     width,
//                                                     height];
   NSString * urlString = [ImageHelper getImageArray][step++];
   NSURL * kittenURL = [NSURL URLWithString:urlString];
